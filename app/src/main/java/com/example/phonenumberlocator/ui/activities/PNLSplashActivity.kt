...
class PNLSplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       /* else {
            loadAndReturnAd(
                this@PNLSplashActivity,
                resources.getString(R.string.admob_native_main_high)
            ) {
                if (it != null) {
        ...
        loadPriorityAdmobInterstitial(getString(R.string.admob_splash_interistitial_high), getString(R.string.admob_splash_interistitial_low)) {
            Log.d("TAG", "ad:$it ")
